...
def main():
    ...
    dataset_root = "/home/rzh/win-pycharm/Trans-T/datasets/got10k" #Absolute path of the dataset
    net_path = "/home/rzh/win-pycharm/Trans-T/pytracking/networks/transt.pth" #Absolute path of the model
